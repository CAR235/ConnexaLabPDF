import { 
  File, FileEdit, FileImage, FileSpreadsheet, FileText, FileType, 
  FilePlus, FileMinus, RotateCcw, FileSearch, FileX, 
  FileCheck, FileDigit, FileUp, FileLock, FileKey2, Stamp, PenTool
} from 'lucide-react';
